  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-center flex-shrink-0 h-full group">
        <img
          className="w-full h-full rounded-lg shadow-md mx-auto object-cover transition ease-in-out duration-300"
          alt="Post cover image"
          src={data.eyeCatchImageUrl}
        />
        <div className="absolute inset-0 transition duration-200 rounded-2xl bg-black/40"></div>
        <div className="absolute inset-0 flex items-end transition duration-200 opacity-100">
          <div className="flex flex-col justify-between flex-1 px-5 pb-5 @xs:px-9 @xs:pb-9 text-white">
